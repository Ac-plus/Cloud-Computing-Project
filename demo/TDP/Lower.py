...
def Lower(documents: str, new_documents: str = None, mode: str = "String") :
    # 参数说明：
    # documents:        文件名或字符串内容
...
'''
#   测试样例1：字符串
print(Lower("ASDFGHBfdtrthgJhgsftERTY"))

#   测试样例2：文本文件
documents =     "test.txt"
new_documents = "test_lower.txt"
Lower(documents, new_documents, mode="Text")
